...
ValidationConfidenceCard.displayName = "ValidationConfidenceCard";
...
export const ValidationLevelCard = React.memo<ValidationLevelCardProps>(
  ({
    icon,
    title,
    level,
...
ValidationLevelCard.displayName = "ValidationLevelCard";
...
ListTextareaCard.displayName = "ListTextareaCard";
