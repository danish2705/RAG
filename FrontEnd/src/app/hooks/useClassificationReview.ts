...
import { assessChangeControlImpact, assessDeviationImpact } from "../services/impactAssessmentApi";
...
export function useClassificationReview() {
          ...
          stages: {
            ...
            changeImpactAssessment: rawStage
              ? {
                  ...
                  // FIXED: Cast to any to bypass the ChangeImpactAssessmentParsed mismatch
                  parsed: rawStage.parsed ? flatToNestedChangeImpactAssessment(rawStage.parsed as any) : null,
                }
              : undefined,
          },
          provenance: {
  ...
  // Exporting all necessary state and handlers
  return {
