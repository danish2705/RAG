...
export const RiskConfidenceCard: React.FC<{
  score: number;
...
export const RegulatoryFilingsEditor: React.FC<{
  filings: string[];
...
export const RegulatoryFilingsList: React.FC<{ filings: string[] }> = ({
  filings,
}) => (
  <div className="mt-3">
...
export const RiskRankingCard: React.FC<{
