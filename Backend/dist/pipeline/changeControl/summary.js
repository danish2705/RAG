...
import { FinalChangeControlSummarySchema, } from "../../llm/schemas/changeControl.js";
 ...
 */
export async function runFinalSummaryStage(query, approvedImpactAssessment, approvedRiskCriticality, approvedValidationTesting, approvedImplementationControl) {
    const userPrompt = `
Change Description:
${query}
...
`.trim();
    const rawText = await callLLM(userPrompt, FINAL_CHANGE_CONTROL_SUMMARY_PROMPT);
    try {
